...
export default async () => {
  const sql = neon();
  try {
const rows = await sql`SELECT id, human_name, biz_name, instagram, facebook, website, description FROM makers WHERE approved = true ORDER BY COALESCE(biz_name, human_name) ASC`;
