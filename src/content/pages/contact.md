...
<form name="contact" method="POST" data-netlify="true" data-netlify-honeypot="bot-field">
  ...
  <p>
    ...
    <textarea id="message" name="message" required rows="8" placeholder="Suggest an event, group, venue - or ask for CMS access to the site" style="width: 100%; padding: 0.5rem; margin-top: 0.25rem; border: 1px solid #ddd; border-radius: 4px; font-family: inherit;"></textarea>
    </label>
  </p>
