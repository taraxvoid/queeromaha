...
Directory pages live as plain YAML in `src/content/pages/*.yaml`. Each file is a category (friends, spiritual, art, cafes, music, makers) with an `items` array. Simple pages (about) are `src/content/pages/*.md`.
